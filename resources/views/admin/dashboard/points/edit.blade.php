...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-12">
			<div class="card">
				<div class="card-body">
					<h4 class="header-title">Editer un point</h4>

					<form method="POST" action="/admin/points/edit/{{ $point->id }}" enctype="multipart/form-data">
						{{ csrf_field() }}
						<div class="row">
							<div class="col-lg-6">
								<div class="mb-3">
							...
							<div class="col-lg-6">
								<div class="mb-3">
									...
									<select name="ville" required class="form-control">
										...
										<option value="{{ $ville->id }}" <?= ($ville->id==$point->ville_id)?'selected':'' ?>>{{ $ville->nom }}</option>
										@endforeach
									</select>
								</div>
							</div>

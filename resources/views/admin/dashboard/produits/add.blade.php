						...
						<div class="row">
							<div class="col-lg-6">
								<div class="mb-3">
									...
									<input type="text" name="nom" required placeholder="Nom du produit" class="form-control" id="nom" />
								</div>
							</div>
							<div class="col-lg-6">
								<div class="mb-3">
									<label for="description" class="form-label">Description<span class="text-danger">*</span></label>
									<textarea type="text" name="description" required placeholder="Description" class="form-control" id="description" ></textarea>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="mb-3">
									...
									<input type="text" name="accompte" required placeholder="Paiement Accompte" class="form-control" id="accompte" />
								</div>
							</div>
							<div class="col-lg-6">
								<div class="mb-3">
									<label for="journalier" class="form-label">Paiement journalier<span class="text-danger">*</span></label>
									<input type="text" name="journalier" required placeholder="Paiement journalier" class="form-control" id="journalier" />
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="mb-3">
									...
									<input type="text" name="duree" required placeholder="Durée" class="form-control" id="duree" />
								</div>
							</div>
							<div class="col-lg-6">
								<div class="mb-3">

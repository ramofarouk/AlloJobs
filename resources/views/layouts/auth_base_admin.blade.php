...
<footer class="footer footer-alt" style="color:white">
  2022 - <script>document.write(new Date().getFullYear())</script> &copy; Allo Jobs Powered by <b style="color:white;font-weight: bold;"  class="text-white-50">Wiicom-Consulting</b> 
</footer>
